...
"""
Simulation Script for Paper ID 3
DOI: 10.1109/tpwrs.2025.3647755
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 3")
print("Title: Improving the Accuracy of DC Optimal Power Flow Formulations via Parameter Optimization")
