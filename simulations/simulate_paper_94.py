...
"""
Simulation Script for Paper ID 94
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 94")
print("Title: An Optimal Power Flow Tool for AC/DC Systems, Applied to the Analysis of the North Sea Grid for Offshore Wind Integration")
