...
"""
Simulation Script for Paper ID 6
DOI: 10.1109/tpwrs.2025.3626450
Title: Reserve Constrained AC Optimal Power Flow Using Accelerated Primal-Dual Interior Point Method
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 6")
print("Title: Reserve Constrained AC Optimal Power Flow Using Accelerated Primal-Dual Interior Point Method")
