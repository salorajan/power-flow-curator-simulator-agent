...
"""
Simulation Script for Paper ID 14
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 14")
print("Title: Adaptive Hybrid Prediction-Correction With Trust-Region and Dynamic Line Search for AC/DC Load Flow")
