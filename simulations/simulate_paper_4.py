...
"""
Simulation Script for Paper ID 4
DOI: 10.1109/tpwrs.2025.3649102
Title: Reliable Transient Stability-Constrained Optimal Power Flow Analysis Based on Polynomial Chaos Expansion
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 4")
print("Title: Reliable Transient Stability-Constrained Optimal Power Flow Analysis Based on Polynomial Chaos Expansion")
