...
"""
Simulation Script for Paper ID 60
DOI: 10.1109/tpwrs.2026.3696764
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 60")
print("Title: Quantum Hardware-in-The-Loop for Optimal Power Flow in Renewable-Integrated Power Systems")
