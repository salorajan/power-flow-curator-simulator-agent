...
"""
Simulation Script for Paper ID 13
DOI: 10.1109/tpwrs.2025.3615679
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 13")
print("Title: Partially Permutation-Invariant Neural Network for Solving Two-Stage Stochastic AC-OPF Problem")
