...
"""
Simulation Script for Paper ID 84
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 84")
print("Title: Optimal Power Flow With Physics-Informed Typed Graph Neural Networks")
