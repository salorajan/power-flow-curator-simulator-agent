...
"""
Simulation Script for Paper ID 36
DOI: 10.1109/tpwrs.2025.3603018
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 36")
print("Title: Bayesian Quantum Neural Network for Renewable- Rich Power Flow With Training Efficiency and Generalization Capability Improvements")
