...
"""
Simulation Script for Paper ID 5
DOI: 10.1109/tpwrs.2025.3641544
...
print("=========================================================================")
print("RUNNING SIMULATION FOR PAPER ID 5")
print("Title: Unified Power Flow Model for Bipolar HVDC Grids in Unbalanced Operation")
